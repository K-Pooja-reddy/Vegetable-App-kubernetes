...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const cartIcon = document.getElementById('cartIcon'); // Cart image element this also new code and in cart.html write id in image
    ...
    // Event listener for the cart icon click to empty the cart -new code to refresh page when cart icon is clicked
