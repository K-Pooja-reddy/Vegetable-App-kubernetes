document.getElementById('orderForm').addEventListener('submit', function(event) {
    ...
    const formData = {
        ...
        vegetables: {
            ...
            spinachQuantity: parseInt(document.getElementById('spinachQty').value, 10),
            coriander: parseInt(document.getElementById('corianderQty').value, 10),
            Karvepaku: parseInt(document.getElementById('KarvepakuQty').value, 10),
            pudina: parseInt(document.getElementById('pudinaQty').value, 10)
        }
    };
